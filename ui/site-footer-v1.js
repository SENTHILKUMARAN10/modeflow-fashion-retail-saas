// SalesDesk footer system — public pages and every in-app view, without continuous DOM observers.
(function(){
  'use strict';
  ...
  function markup(){return `<div class="velora-site-footer__grid"><div class="velora-site-footer__brand"><a class="velora-site-footer__logo" href="/" aria-label="SalesDesk home"><span class="velora-site-footer__mark">S</span><span class="velora-site-footer__word">SalesDesk</span></a><p class="velora-site-footer__tag">One calm workspace for sales, customers, products or services, expenses, inventory and business performance.</p></div><div><span class="velora-site-footer__eyebrow">Product</span><nav class="velora-site-footer__links"><a href="/#how">How it works</a><a href="/#features">Features</a><a href="/#pricing">Pricing</a><a href="/#login">Sign in</a></nav></div><div><span class="velora-site-footer__eyebrow">Company</span><nav class="velora-site-footer__links"><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="/refund-policy">Refund policy</a><a class="velora-site-footer__email" href="mailto:support@salesdesk.app">support@salesdesk.app</a></nav></div></div><div class="velora-site-footer__bottom"><span>© 2026 SalesDesk. All rights reserved.</span><span><b>Business, made clear.</b> Built for everyday businesses.</span></div>`;}
