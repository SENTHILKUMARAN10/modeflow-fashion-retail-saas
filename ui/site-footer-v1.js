// Velora footer system — public pages and every in-app view.
(function(){
  'use strict';
  ...
  style.textContent=`
    ...
    #veloraLanding>.velora-site-footer{margin-top:0;padding-top:52px}
    #login>.velora-site-footer{margin-top:0}
    .view>.velora-site-footer{margin-left:calc(clamp(24px,4vw,54px) * -1);margin-right:calc(clamp(24px,4vw,54px) * -1);margin-bottom:calc(clamp(24px,4vw,54px) * -1)}
  ...
  function markup(){return `<div class="velora-site-footer__grid">
    <div class="velora-site-footer__brand"><a class="velora-site-footer__logo" href="/" aria-label="Velora home"><span class="velora-site-footer__mark">V</span><span class="velora-site-footer__word">Velora</span></a><p class="velora-site-footer__tag">One calm workspace for sales, customers, products or services, expenses, inventory and business performance.</p></div>
    <div><span class="velora-site-footer__eyebrow">Product</span><nav class="velora-site-footer__links"><a href="/#how">How it works</a><a href="/#features">Features</a><a href="/#pricing">Pricing</a><a href="/#login">Sign in</a></nav></div>
    <div><span class="velora-site-footer__eyebrow">Company</span><nav class="velora-site-footer__links"><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="/refund-policy">Refund policy</a><a class="velora-site-footer__email" href="mailto:support@velora.app">support@velora.app</a></nav></div>
  </div><div class="velora-site-footer__bottom"><span>© 2026 Velora. All rights reserved.</span><span><b>Business, made clear.</b> Built for everyday businesses.</span></div>`;}
  ...
  function ensure(container,kind){if(!container)return;const direct=[...container.children].find(el=>el.matches?.(`.velora-site-footer[data-velora-footer="${kind}"]`));if(!direct)container.appendChild(makeFooter(kind));}
  ...
  function refresh(){
    ...
    if(!landing&&!login&&!document.querySelector('#app .view'))ensure(document.body,'standalone');
  }
