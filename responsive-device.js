(function(){
  ...
  function loadDeviceLayer(){
    ...
    addCss('link[data-mf-premium]','premium-v5.css?v=20260910-1348','data-mf-premium');
    addCss('link[data-mf-mobile-drawer]','mobile-drawer-v1.css?v=20260910-1348','data-mf-mobile-drawer');
    addCss('link[data-mf-billing]','ui/billing-v1.css?v=20260910-1348','data-mf-billing');
    addScript('script[data-mf-account-pages],script[src*="account-pages-v1.js"]','account-pages-v1.js?v=20260910-1348','data-mf-account-pages');
    addScript('script[data-mf-billing],script[src*="ui/billing-v1.js"]','ui/billing-v1.js?v=20260910-1348','data-mf-billing');
    addScript('script[data-mf-mobile-drawer],script[src*="mobile-drawer-v1.js"]','mobile-drawer-v1.js?v=20260910-1348','data-mf-mobile-drawer');
    addScript('script[data-velora-excel-export],script[src*="ui/export-excel-v1.js"]','ui/export-excel-v1.js?v=20260910-1348','data-velora-excel-export');
    addScript('script[data-velora-site-footer],script[src*="ui/site-footer-v1.js"]','ui/site-footer-v1.js?v=20260910-1348','data-velora-site-footer');
    addScript('script[data-client-branding],script[src*="ui/client-branding-v2.js"]','ui/client-branding-v2.js?v=20260910-1348','data-client-branding');
