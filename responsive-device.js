(function(){
  ...
  function loadDeviceLayer(){
    ...
    addCss('link[data-salesdesk-people-intelligence]','ui/salesdesk-people-intelligence-v1.css?v='+v,'data-salesdesk-people-intelligence');
    addCss('link[data-salesdesk-automation-center]','ui/salesdesk-automation-center-v1.css?v='+v,'data-salesdesk-automation-center');
    ...
    addScript('script[data-salesdesk-pro-v1],script[src*="ui/salesdesk-pro-suite-v1.js"]','ui/salesdesk-pro-suite-v1.js?v='+v,'data-salesdesk-pro-v1');
    addScript('script[data-salesdesk-pos-v1],script[src*="ui/salesdesk-pos-v1.js"]','ui/salesdesk-pos-v1.js?v='+v,'data-salesdesk-pos-v1');
    addScript('script[data-salesdesk-finance-v1],script[src*="ui/salesdesk-finance-v1.js"]','ui/salesdesk-finance-v1.js?v='+v,'data-salesdesk-finance-v1');
    addScript('script[data-salesdesk-notification-inbox],script[src*="ui/salesdesk-notification-inbox-v1.js"]','ui/salesdesk-notification-inbox-v1.js?v='+v,'data-salesdesk-notification-inbox');
    addScript('script[data-salesdesk-import],script[src*="ui/salesdesk-import-v1.js"]','ui/salesdesk-import-v1.js?v='+v,'data-salesdesk-import');
    addScript('script[data-salesdesk-account-security],script[src*="ui/salesdesk-account-security-v1.js"]','ui/salesdesk-account-security-v1.js?v='+v,'data-salesdesk-account-security');
    addScript('script[data-salesdesk-backup-v2],script[src*="ui/salesdesk-backup-v2.js"]','ui/salesdesk-backup-v2.js?v='+v,'data-salesdesk-backup-v2');
