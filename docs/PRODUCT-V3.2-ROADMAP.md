...
| 3 | Suppliers | PARTIAL | CRUD + one-tap duplicate + purchases + payments + payables + ledger/statement (date-filtered) + copy/CSV/print done + New purchase (opens purchase bill with supplier prefilled). Remaining: POs, returns, debit notes |
